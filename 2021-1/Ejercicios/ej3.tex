...
\item En un día lluvioso sin viento, en donde las gotas caen verticalmente a velocidad constante con respecto a la Tierra, pasa un tren a una rapidez de \SI{70}{km/h}. Los pasajeros del tren constatan que las gotas de lluvia dejan huellas en las ventanas laterales inclinadas en un ángulo de $60^{\circ}$ con respecto a la vertical. Determine la \textbf{velocidad}~(dirección y magnitud) de la lluvia en relación:
