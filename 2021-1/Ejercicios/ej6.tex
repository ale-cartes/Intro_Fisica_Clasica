...
\item Un bloque de masa $m$ se encuentra unido a un resorte de constante elástica $k$ y largo natural nulo, cuyo extremo está a una altura $H$ de una cinta sobre la cual se apoya el bloque. Esta cinta posee un coeficiente de roce estático $\mu_e$ y cinético $\mu_c$, y se mueve con rapidez $v_0$ hacia la derecha. Determine el ángulo $\beta$ para que el bloque deje de estar en reposo con respecto a la cinta y comienza a deslizarse hacia la izquierda. 


\begin{figure}[htbp]
  \centering
  \svgpath{../Imagenes/ejercicios}
  \includesvg[width=0.55\linewidth]{ej6.svg}
\end{figure}
